...
class GroupExceptionHandler extends BaseExceptionHandler {
    ...
    ResponseEntity<ErrorDto> handleGroupNotFoundException(GroupNotFoundException ex, WebRequest request) {
    ...
    ResponseEntity<ErrorDto> handleGroupRoleNotFoundException(GroupRoleNotFoundException ex, WebRequest request) {
        return ResponseEntity
                .status(HttpStatus.NOT_FOUND)
                .body(ErrorDto.builder()
                        .statusCode(HttpStatus.NOT_FOUND.value())
